...
CAVE_ENTRANCES = PUZZLE_CAVE_ENTRANCES + MIXED_CAVE_ENTRANCES + COMBAT_CAVE_ENTRANCES + FAIRY_ENTRANCES
...
CAVE_EXITS = PUZZLE_CAVE_EXITS + MIXED_CAVE_EXITS + COMBAT_CAVE_EXITS + FAIRY_EXITS

DUNGEON_ENTRANCE_NAMES_WITH_NO_REQUIREMENTS = [
  "Path to Valoo on Dragon Roost Island",
]
PUZZLE_CAVE_ENTRANCE_NAMES_WITH_NO_REQUIREMENTS = [
  "Inlet on Cliff Plateau Isles"
]
MIXED_CAVE_ENTRANCE_NAMES_WITH_NO_REQUIREMENTS = [
  "Cave Opening in Shell on Pawprint Isle"
]
COMBAT_CAVE_ENTRANCE_NAMES_WITH_NO_REQUIREMENTS = [
]
CAVE_ENTRANCE_NAMES_WITH_NO_REQUIREMENTS = PUZZLE_CAVE_ENTRANCE_NAMES_WITH_NO_REQUIREMENTS + MIXED_CAVE_ENTRANCE_NAMES_WITH_NO_REQUIREMENTS + COMBAT_CAVE_ENTRANCE_NAMES_WITH_NO_REQUIREMENTS
...
PUZZLE_CAVE_EXIT_NAMES_WITH_NO_REQUIREMENTS = [
  "Ice Ring Isle Secret Cave",
  "Diamond Steppe Island Warp Maze Cave"
]
MIXED_CAVE_EXIT_NAMES_WITH_NO_REQUIREMENTS = [
  "Pawprint Isle Chuchu Cave"
]
COMBAT_CAVE_EXIT_NAMES_WITH_NO_REQUIREMENTS = [
  "Rock Spire Isle Keese Cave"
]
CAVE_EXIT_NAMES_WITH_NO_REQUIREMENTS = PUZZLE_CAVE_EXIT_NAMES_WITH_NO_REQUIREMENTS + MIXED_CAVE_EXIT_NAMES_WITH_NO_REQUIREMENTS + COMBAT_CAVE_EXIT_NAMES_WITH_NO_REQUIREMENTS
